...
import { CircleDot, BarChart2, Settings, Check, Sparkles, X, RotateCcw, Volume2, VolumeX, Smartphone, ChevronLeft, ChevronRight, Bell, Clock, CalendarDays, TrendingUp, Star, Heart, Download } from 'lucide-react';
    ...
    >
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="bg-white rounded-[2rem] p-8 border border-outline/10 shadow-[0_8px_30px_rgba(0,0,0,0.01)]">
            <div className="flex items-center gap-3 mb-6">
